  ...
  return (
    <div>
      <div className="mb-8 space-y-4">
        ...
        <p className="text-muted-foreground font-light text-sm md:text-lg text-center mx-4">
          The only limit is your imagination. Start generating what you could only dream about with the click of a button.
        </p>
      </div>
